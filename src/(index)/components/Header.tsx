...
export default function Header() {
  return (
    <header
      className="relative flex w-full items-center justify-center bg-cover bg-no-repeat"
      style={{
        backgroundImage: `linear-gradient(rgba(1,1,1,.5), rgba(1,1,1,.5)), url('/images/your-image.jpg')`,
      }}
    >
